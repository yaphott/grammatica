...
TEST_F(CharRangeTest, FromChars) {
	...
	free(rendered);
	grammatica_char_range_destroy(range);
}
...
INSTANTIATE_TEST_SUITE_P(
    CharRangeSimplifyTests,
    CharRangeSimplifyTest,
    ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(CharRangeRenderTests,
                         CharRangeRenderTest,
...
TEST_F(CharRangeTest, Equals) {
	...
	grammatica_char_range_destroy(range1);
	grammatica_char_range_destroy(range2);
	grammatica_char_range_destroy(range3);
}
...
TEST_F(CharRangeTest, Copy) {
	...
	grammatica_char_range_destroy(original);
