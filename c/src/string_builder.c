...
// 	if (!sb) {
// 		grammatica_report_error_with_code(ctx, GRAMMATICA_ERROR_OUT_OF_MEMORY, "Failed to allocate string builder");
// 		return NULL;
// 	}
// 
...
// 	if (!sb->data) {
// 		free(sb);
// 		grammatica_report_error_with_code(ctx, GRAMMATICA_ERROR_OUT_OF_MEMORY, "Failed to allocate string builder buffer");
// 		return NULL;
// 	}
// 
// 	sb->data[0] = '\0';
...
// 	if (!new_data) {
// 		grammatica_report_error_with_code(sb->ctx, GRAMMATICA_ERROR_OUT_OF_MEMORY, "Failed to grow string builder buffer");
// 		return false;
// 	}
// 
// 	sb->data = new_data;
